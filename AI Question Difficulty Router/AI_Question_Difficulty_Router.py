...
t2=PromptTemplate(
    template="generate simple answer of 2-3 lines for the basic level question: {ques} also tell the question's level of difficulty in starting line",
    input_variables=["ques"]
)

t3=PromptTemplate(
    template="generate detailed answer of around 200-300 words for the intermediate level question: {ques} also tell the question's level of difficulty in starting line",
    input_variables=["ques"]
)
